...
public class LibSchedule extends AppCompatActivity {
    ...
    public void getSche() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    linearLayoutManager3 = new LinearLayoutManager(LibSchedule.this, LinearLayoutManager.VERTICAL, false);
                    recyclerView3.setLayoutManager(linearLayoutManager3);
                    adapterData3 = new AdapterData3(LibSchedule.this, listData3);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(LibSchedule.this);
        requestQueue.add(request);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lib_schedule);
        recyclerView3 = findViewById(R.id.rvData4);
        getSche();
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LibSchedule.this, ScheduleForm.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LibSchedule.this, Profile.class);
                startActivity(intent);
            }
        });
    }
